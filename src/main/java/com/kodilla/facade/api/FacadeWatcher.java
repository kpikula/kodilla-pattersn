...
public class FacadeWatcher {
    ...
    @AfterThrowing(pointcut = "execution(* com.kodilla.facade.api.OrderFacade.processOrder(..))", throwing = "error")
    ...
    @Around("execution(* com.kodilla.facade.api.OrderFacade.processOrder(..))")
    ...
    @AfterReturning("execution(* com.kodilla.facade.api.OrderFacade.processOrder(..))")
    public void logEventReturning() {
        LOGGER.info("Logging the event ended without error");
    }

    @After("execution(* com.kodilla.facade.api.OrderFacade.processOrder(..))")
